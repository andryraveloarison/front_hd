    ...
    return (
        <div className='w-screen flex'>
                    ...
                    
            {
                ...
                <div className="w-[75%] bg-secondary h-[80px] mt-14 items-center px-14 ml-6 ">
                    <div className="items-center">
                        <h3 className='text-lg '> {messages.contenu.ticketTitre} </h3>
                    </div>

                    <div className="ml-6">
                        <p className="text-lg font-light text-gray-600"> {messages.contenu.ticketContenu}</p>
                    </div>  
